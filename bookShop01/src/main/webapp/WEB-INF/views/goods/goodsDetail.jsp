...
<script type="text/javascript">
	...
	function fn_order_each_goods(goods_id, goods_title, goods_sales_price,
		...
		var order_goods_qty = document.getElementById("order_goods_qty"); //수문수량을 받아옴
...
<body>
	...
	<div id="detail_table">
		<table>
			<tbody>
				...
				<tr>
					...
					<td class="fixed">
						<strong>[당일배송]</strong> 당일배송 서비스 시작!
						<br>
		...
		<ul>
			<li>
				<a class="buy" href="javascript:fn_order_each_goods('${goods.goods_id }','${goods.goods_title }','${goods.goods_sales_price}','${goods.goods_fileName}');">구매하기 </a>
			</li>
			<li>
